        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          <div className="space-y-10">
            ...
            >
              ...
              <p className="mt-4 text-gray-700">
                Contributed to multiple projects using React, Node.js, and Express. Focused on building 
                scalable web applications with an emphasis on performance.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="mt-4 text-gray-700">
                Developed responsive user interfaces and integrated third-party APIs with React. 
                Ensured the seamless user experience on mobile and desktop devices.
              </p>
            </motion.div>
          ...
          <div className="space-y-8">
            ...
            >
              ...
              <p className="mt-4 text-center">
                Proficient in creating back-end services using Node.js, building RESTful APIs,
                 and handling real-time data with WebSockets.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="mt-4 text-center">
                Strong knowledge of semantic HTML5 for creating accessible and SEO-friendly web pages,
