    ...
    <section className="py-8 sm:py-12 bg-[#121212] relative mt-0 sm:mt 0">
      <div className="grid grid-cols-1 sm:grid-cols-12 relative z-10">
        ...
        >
          ...
          <p className="text-[#ADB7BE] text-sm sm:text-lg mb-3 sm:mb-6 lg:text-xl max-w-[440px] mx-auto ">
            Experienced in creating dynamic, user-friendly applications. Passionate about crafting impactful 
            digital experience with modern tech.
          </p>
          <div className="flex flex-col sm:flex-row items-center">
            ...
            <a
              href="/cv.pdf" 
              download="Maryam_Nazir_CV.pdf" 
              className="px-2 inline-block py-3 w-150px sm:w-auto rounded-full border-2 border-purple-600
               text-white bg-transparent hover:bg-slate-800 transition-all duration-300 shadow-md shadow-purple-500 text-2xl sm:text-lg lg:text-2x1"
            >
