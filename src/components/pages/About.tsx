        ...
        <div className="flex flex-col md:flex-row items-center justify-between space-y-8 md:space-y-0">
          ...
          >
           ...
           <p className="text-lg md:text-xl text-[#ADB7BE] max-w-lg mx-auto ml-[50px]">
             Hi! I&apos;m Maryam, a passionate web developer and a lifelong learner. I specialize in creating
           ...
           <p className="text-lg md:text-xl text-[#ADB7BE] max-w-md mx-auto ml-[50px]">
            ...
            <div className="flex flex-nowrap justify-center md:justify-start gap-2 md:gap-4 mt-6 mb-[-30px] ml-[50px]">
              {[ 
                { icon: FaGithub, link: "https://github.com/Maryam-Nazir" },
                { icon: FaLinkedin, link: "https://www.linkedin.com/in/MaryamNazir" },
                { icon: FaFacebook, link: "https://www.facebook.com/MaryamNazir" },
                { icon: FaTwitter, link: "https://twitter.com/MaryamNazir" },
