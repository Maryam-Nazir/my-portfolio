          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-8">
              ...
              >
                ...
                <p className="mt-4 text-center text-lg-1">maryamnazir948@gmail.com</p>
              </motion.div>
              <motion.div
                initial={{ opacity: 0, y: 50 }}
                animate={{ opacity: 1, y: 0 }}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full p-3 mt-2 bg-[#1c1c1c] border border-[#9b59b6]
                       text-white text-lg rounded-lg shadow-md focus:outline-none focus:ring-2
                        focus:ring-[#9b59b6] hover:shadow-[0_5px_20px_rgba(128,0,128,0.6)]"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleInputChange}
                      className="w-full p-3 mt-2 bg-[#1c1c1c] border border-[#9b59b6] text-white 
                      text-lg rounded-lg shadow-md focus:outline-none focus:ring-2 focus:ring-[#9b59b6] hover:shadow-[0_5px_20px_rgba(128,0,128,0.6)]"
                    />
                  </div>
                </div>
