...
const Services: React.FC = () => {
  ...
  <div className="flex justify-center items-center mt-8 w-full max-w-[1800px] mx-auto relative">
    <button
      onClick={handlePrev}
      className="text-white text-2xl p-2 bg-[#333333] rounded-full absolute left-[-50px] lg:left-[-60px]
       top-1/2 transform -translate-y-1/2 shadow-xl hover:scale-110 hover:bg-[#9b59b6] transition-all"
      style={{ zIndex: 10 }}
    >
      ◀
    </button>
    ...
    <button
      onClick={handleNext}
      className="text-white text-2xl p-2 bg-[#333333] rounded-full absolute right-[-40px] lg:right-[-50px] top-1/2 transform -translate-y-1/2 shadow-xl hover:scale-110 hover:bg-[#9b59b6] transition-all"
      style={{ zIndex: 10 }}
    >
      ▶
    </button>
